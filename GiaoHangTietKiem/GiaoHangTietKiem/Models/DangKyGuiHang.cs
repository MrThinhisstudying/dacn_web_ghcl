...
public class DangKyGuiHang
{
    public DangKyGuiHang(String tenKH, String sDTKh, String ls_province, String ls_district, String ls_ward, String diaChiKH, String gioiTinhKH, String tenKN, String sDTKN, String ls_province1, String ls_district1, String ls_ward1, String diaChiKN, String gioiTinhKN, int kg, String maLVC)
    {
        this.tenKH = tenKH;
        this.sDTKh = sDTKh;
    ...
    public String getFullAddressKH(DangKyGuiHang dangKy)
    {
        return dangKy.getDiaChiKH() + ", " + dangKy.getLs_ward() + ", " + dangKy.getLs_district() + ", " + dangKy.getLs_province();
    }
    public String getFullAddressKN(DangKyGuiHang dangKy)
    {
